...
var ASM_CONSTS = {
  3908: function() {var cvs = document.createElement("canvas"); cvs.setAttribute("display", "none"); let ctx = cvs.getContext("2d"); var txt = "Haventec <canvas> ❤️🤪🎉👋"; ctx.textBaseline = "top"; ctx.fillStyle = "rgba(102, 204, 0, 0.7)"; ctx.fillText(txt, 50.0, 70.0); ctx.beginPath(); var my_gradient = ctx.createLinearGradient(0, 0, 0, 170); my_gradient.addColorStop(0, "black"); my_gradient.addColorStop(1, "white"); ctx.fillStyle = my_gradient; ctx.fillRect(20, 20, 150, 100); ctx.stroke(); ctx.font = "14px 'Arial'"; ctx.textBaseline = "alphabetic"; ctx.fillStyle = "#f60"; ctx.fillRect(125,1,62,20); ctx.fillStyle = "#069"; ctx.fillText(txt, 2, 15); ctx.fillStyle = "rgba(102, 204, 0, 0.7)"; ctx.fillText(txt, 4, 17); let output = cvs.toDataURL(); var lengthBytes = lengthBytesUTF8(output)+1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(output, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap;}
};
